...
./patchpbz.py -v v$NEW_VERSION-3v7 -b Pebble-4.3-silk.pbz Pebble-$NEW_VERSION-silk-3v7.pbz -t tzdata.bin.reso --license rbl-license.txt --silk-3v7

NEW_VERSION_V3=3.13.1-rbl
